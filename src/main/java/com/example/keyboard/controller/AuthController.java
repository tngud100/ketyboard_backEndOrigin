...
public class AuthController {
    ...
    @Operation(summary = "비밀번호 일치 로직")
    @PostMapping("/checkPassword")
    public ResponseEntity<Object> checkPassword(@RequestParam("loginId") String loginId, @RequestParam("password") String password){
        try {
            boolean isCorrect = authService.checkPassword(loginId, password);
