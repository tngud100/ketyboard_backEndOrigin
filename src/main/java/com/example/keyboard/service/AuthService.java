...
public class AuthService {
    ...
    public AuthService( JWTUtil jwtUtil, RedisUtils redisUtils, AuthDao authDao, PasswordEncoder passwordEncoder) {
    ...
    public boolean checkPassword(String loginId, String password) throws Exception {
        MemberEntity member = authDao.findByLoginId(loginId);
